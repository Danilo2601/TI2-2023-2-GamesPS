	...
	public Object criaPag(Request request,Response response) {
		...
		for(Jogo a : jogos) {
			pegaJogo2 += "<div class=\"cardio\">\r\n"
					+ "        <a class=\"barra-azul\" href=\"pagJogo/chatdecomunidade/chatcomunidade.html#1\" target=\"_blank\">\r\n"
					+ "          </a><h3><a class=\"barra-azul\" href=\"pagJogo/chatdecomunidade/chatcomunidade.html#1\" target=\"_blank\"> <img class=\"logo\" src=\""+a.getImagens()[0]+"\" <=\"\" h3=\"\">\r\n"
					+ "          </a>\r\n"
					+ "        </h3></div>";
		}
